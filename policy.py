...
class BasePolicy:
    """
    Interface à implémenter pour toute politique (règles codées ou réseau de neurones).
    Ne jamais modifier l'état de world ou agent depuis ici.
    """
    ...
    def decide_reproduce(self, agent, world):
        """Retourne True si l'agent doit se reproduire ce tick."""
        raise NotImplementedError
...
class HardcodedPolicy(BasePolicy):
    ...
    Sert de baseline comportementale — remplacer par un réseau entraîné.
    """
